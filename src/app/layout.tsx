...
export const metadata: Metadata = {
  title: "Werkstatt Sassenberg | technotrans SE",
  description: "Werkstatt technotrans SE in Sassenberg: kompetenter Service und zuverlässige Reparaturen. Jetzt Termin vereinbaren und Fachwissen erleben!",
  openGraph: {
    title: "Werkstatt Sassenberg | technotrans SE",
    description: "Werkstatt technotrans SE in Sassenberg: kompetenter Service und zuverlässige Reparaturen. Jetzt Termin vereinbaren und Fachwissen erleben!",
    type: "website",
